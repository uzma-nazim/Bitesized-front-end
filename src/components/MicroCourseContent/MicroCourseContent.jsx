    ...
    <div className="container">
      <form onSubmit={handleSubmit}>
        <div className="allcontentpadding">
          <div>
            <h1 className="stepbystepprocess">
          ...
          <div className="numsflex">
            <p
              ...
              className={age_group == 6 ? "hover_active" : ""}
            >
              6
            </p>
            <p
              onClick={() => handleSelect(7)}
              className={age_group == 7 ? "hover_active" : ""}
            >
              7
            </p>
            <p
              onClick={() => handleSelect(8)}
              className={age_group == 8 ? "hover_active" : ""}
            >
              8
            </p>
            <p
              onClick={() => handleSelect(9)}
              className={age_group == 9 ? "hover_active" : ""}
            >
              9
            </p>
            <p
              onClick={() => handleSelect(10)}
              className={age_group == 10 ? "hover_active" : ""}
            >
              10
            </p>
            <p
              onClick={() => handleSelect(11)}
              className={age_group == 11 ? "hover_active" : ""}
            >
              11
            </p>
            <p
              onClick={() => handleSelect(12)}
              className={age_group == 12 ? "hover_active" : ""}
            >
              12
            </p>
            <p
              onClick={() => handleSelect(13)}
              className={age_group == 13 ? "hover_active" : ""}
            >
              13
            </p>
          </div>
          ...
          {showThumbnail ? (
            <img
              ...
              alt=""
              width={"100px"}
              style={{ marginTop: "30px", height: "160px", objectFit: "cover" }}
            />
          ) : (
          ...
          <div className="savebtnflex">
            ...
            <button type="submit" className="savecontinue">
